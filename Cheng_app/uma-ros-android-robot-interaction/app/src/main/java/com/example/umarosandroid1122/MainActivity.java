...
public class MainActivity extends AppCompatActivity {
    ...
    private ListenableFuture<ProcessCameraProvider> cameraProviderFuture2;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PendingIntent updatedPendingIntent = PendingIntent.getActivity(this,
        ...
        */
        ...
        enableSelfieCamera = intent.getBooleanExtra(CustomMasterChooser.ENABLE_SELFIE, false);
        ...
        selfieView = (TextView) findViewById(R.id.selfieText);
        ...
        if(enableSelfieCamera) {
            cameraProviderFuture2 = ProcessCameraProvider.getInstance(this);
            selfieView.setText(R.string.selfie_on);
        }
        else {
            selfieView.setText(R.string.selfie_off);
        }
    ...
    protected void init(NodeMainExecutor nodeMainExecutor) {
        ...
        if(enableSelfieCamera) {
            SelfieNode selfieNode = new SelfieNode(this,cameraProviderFuture2,nodeName);
            nodeMainExecutor.execute(selfieNode, nodeConfiguration);
        }
